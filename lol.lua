...
local Themes = {
	...
	Solarized Dark = {
    	...
    	AcrylicNoise = 1,
    	TitleBarLine = Color3.fromRGB(42, 161, 152), -- focusBorder
    	Tab = Color3.fromRGB(131, 148, 150), -- editor.foreground
    	Element = Color3.fromRGB(0, 56, 71), -- input.background
    	ElementBorder = Color3.fromRGB(42, 161, 152), -- focusBorder
    	InElementBorder = Color3.fromRGB(42, 161, 152), -- String color
    	ElementTransparency = 0,
    	ToggleSlider = Color3.fromRGB(42, 161, 152), -- String color
    	ToggleToggled = Color3.fromRGB(0, 43, 54), -- editor.background
   		SliderRail = Color3.fromRGB(42, 161, 152), -- String color
    	DropdownFrame = Color3.fromRGB(0, 33, 43), -- dropdown.background
    	DropdownHolder = Color3.fromRGB(0, 33, 43), -- dropdown.background
    	DropdownBorder = Color3.fromRGB(42, 161, 152), -- dropdown.border
    	...
    	DialogButtonBorder = Color3.fromRGB(42, 161, 152), -- focusBorder
    	DialogBorder = Color3.fromRGB(42, 161, 152), -- focusBorder
    	DialogInput = Color3.fromRGB(0, 56, 71), -- input.background
    	DialogInputLine = Color3.fromRGB(42, 161, 152), -- String color
