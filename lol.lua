...
local Themes = {
	...
	Solarizeddark = {
		Name = "Solarizeddark",	
		Accent = Color3.fromRGB(5, 3, 3), -- String color as accent
    	AcrylicMain = Color3.fromRGB(5, 3, 3), -- editor.background
    	AcrylicBorder = Color3.fromRGB(2, 3, 3), -- editor.lineHighlightBackground
    	AcrylicGradient = ColorSequence.new(Color3.fromRGB(0, 43, 54), Color3.fromRGB(0, 43, 54)),
    	AcrylicNoise = 1,
    	TitleBarLine = Color3.fromRGB(117, 5, 5), -- focusBorder
    	Tab = Color3.fromRGB(131, 148, 150), -- editor.foreground
    	Element = Color3.fromRGB(145, 12, 3), -- input.background
    	ElementBorder = Color3.fromRGB(5, 5, 5), -- focusBorder
    	InElementBorder = Color3.fromRGB(117, 5, 5), -- String color
    	ElementTransparency = 0,
    	ToggleSlider = Color3.fromRGB(117, 5, 5), -- String color
    	ToggleToggled = Color3.fromRGB(10, 10, 10), -- editor.background
   		SliderRail = Color3.fromRGB(117, 5, 5), -- String color
    	DropdownFrame = Color3.fromRGB(0, 33, 43), -- dropdown.background
    	DropdownHolder = Color3.fromRGB(0, 33, 43), -- dropdown.background
    	DropdownBorder = Color3.fromRGB(117, 5, 5), -- dropdown.border
    	DropdownOption = Color3.fromRGB(131, 148, 150), -- foreground
    	Keybind = Color3.fromRGB(145, 12, 3), -- input.background
    	Input = Color3.fromRGB(3, 3, 3), -- input.background
    	InputFocused = Color3.fromRGB(145, 12, 3), -- input.background
    	InputIndicator = Color3.fromRGB(147, 161, 161), -- input.placeholderForeground
    	Dialog = Color3.fromRGB(0, 33, 43), -- editorWidget.background
 		DialogHolder = Color3.fromRGB(1, 2, 3), -- editor.background
    	DialogHolderLine = Color3.fromRGB(7, 54, 66), -- editor.lineHighlightBackground
    	DialogButton = Color3.fromRGB(145, 12, 3), -- input.background
    	DialogButtonBorder = Color3.fromRGB(117, 5, 5), -- focusBorder
    	DialogBorder = Color3.fromRGB(117, 5, 5), -- focusBorder
    	DialogInput = Color3.fromRGB(145, 12, 3), -- input.background
