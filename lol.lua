...
local Themes = {
	...
	Solarizeddark = {
		Name = "Solarizeddark",	
		Accent = Color3.fromRGB(192, 0, 0), -- لون مميز (أحمر)
    	AcrylicMain = Color3.fromRGB(0, 0, 0), -- خلفية المحرر (أسود)
    	AcrylicBorder = Color3.fromRGB(20, 20, 20), -- تمييز الخطوط (أسود غامق)
    	AcrylicGradient = ColorSequence.new(Color3.fromRGB(0, 0, 0), Color3.fromRGB(0, 0, 0)),
    	AcrylicNoise = 1,
    	TitleBarLine = Color3.fromRGB(192, 0, 0), -- خط العنوان (أحمر)
    	Tab = Color3.fromRGB(150, 0, 0), -- لون النص (أحمر داكن)
    	Element = Color3.fromRGB(20, 20, 20), -- خلفية الإدخال (أسود غامق)
    	ElementBorder = Color3.fromRGB(192, 0, 0), -- حدود العنصر (أحمر)
    	InElementBorder = Color3.fromRGB(192, 0, 0), -- لون النص داخل العناصر (أحمر)
    	ElementTransparency = 0,
    	ToggleSlider = Color3.fromRGB(192, 0, 0), -- لون السلايدر (أحمر)
    	ToggleToggled = Color3.fromRGB(0, 0, 0), -- لون الخلفية عند التفعيل (أسود)
   		SliderRail = Color3.fromRGB(192, 0, 0), -- لون السكة (أحمر)
    	DropdownFrame = Color3.fromRGB(10, 10, 10), -- خلفية القائمة المنسدلة (أسود)
    	DropdownHolder = Color3.fromRGB(10, 10, 10), -- نفس لون الخلفية
    	DropdownBorder = Color3.fromRGB(192, 0, 0), -- حدود القائمة (أحمر)
    	DropdownOption = Color3.fromRGB(200, 50, 50), -- لون الخيارات (أحمر فاتح)
    	Keybind = Color3.fromRGB(20, 20, 20), -- خلفية الإدخال (أسود)
    	Input = Color3.fromRGB(20, 20, 20), -- نفس اللون
    	InputFocused = Color3.fromRGB(20, 20, 20), -- نفس اللون
    	InputIndicator = Color3.fromRGB(150, 0, 0), -- مؤشر الإدخال (أحمر داكن)
    	Dialog = Color3.fromRGB(10, 10, 10), -- خلفية الحوارات (أسود)
 		DialogHolder = Color3.fromRGB(0, 0, 0), -- خلفية الحاوية (أسود)
    	DialogHolderLine = Color3.fromRGB(20, 20, 20), -- خط تمييز (أسود غامق)
    	DialogButton = Color3.fromRGB(20, 20, 20), -- زر الحوارات (أسود)
    	DialogButtonBorder = Color3.fromRGB(192, 0, 0), -- حدود الزر (أحمر)
    	DialogBorder = Color3.fromRGB(192, 0, 0), -- حدود الحوار (أحمر)
    	DialogInput = Color3.fromRGB(20, 20, 20), -- إدخال الحوارات (أسود)
    	DialogInputLine = Color3.fromRGB(192, 0, 0), -- خط الإدخال (أحمر)
    	Text = Color3.fromRGB(200, 50, 50), -- لون النص الرئيسي (أحمر فاتح)
    	SubText = Color3.fromRGB(150, 0, 0), -- لون النص الثانوي (أحمر داكن)
    	Hover = Color3.fromRGB(40, 0, 0), -- لون التحويم (أحمر غامق)
    	HoverChange = 0.1,
},
	AMOLED = {
		Name = "AMOLED",
