...
local Themes = {
	...
	Solarizeddark = {
		...
		Accent = Color3.fromRGB(8, 2, 1), -- String color as accent
    		...
    		AcrylicNoise = 1,
    		TitleBarLine = Color3.fromRGB(8, 2, 1), -- focusBorder
    		Tab = Color3.fromRGB(131, 148, 150), -- editor.foreground
    		Element = Color3.fromRGB(0, 56, 71), -- input.background
    		ElementBorder = Color3.fromRGB(8, 2, 1), -- focusBorder
    		InElementBorder = Color3.fromRGB(8, 2, 1), -- String color
    		ElementTransparency = 0,
    		ToggleSlider = Color3.fromRGB(8, 2, 1), -- String color
    		ToggleToggled = Color3.fromRGB(8, 2, 1), -- editor.background
   		SliderRail = Color3.fromRGB(8, 2, 1), -- String color
    		DropdownFrame = Color3.fromRGB(0, 33, 43), -- dropdown.background
    		DropdownHolder = Color3.fromRGB(0, 33, 43), -- dropdown.background
    		DropdownBorder = Color3.fromRGB(8, 2, 1), -- dropdown.border
 		...
 		DialogHolder = Color3.fromRGB(8, 2, 1), -- editor.background
    		...
    		DialogButtonBorder = Color3.fromRGB(8, 2, 1), -- focusBorder
    		DialogBorder = Color3.fromRGB(8, 2, 1), -- focusBorder
    		DialogInput = Color3.fromRGB(0, 56, 71), -- input.background
    		DialogInputLine = Color3.fromRGB(8, 2, 1), -- String color
