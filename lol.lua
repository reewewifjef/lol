...
local Themes = {
	...
	Solarizeddark = {
		...
		Accent = Color3.fromRGB(199, 4, 4), -- String color as accent
    		AcrylicMain = Color3.fromRGB(74, 9, 1), -- editor.background
    		AcrylicBorder = Color3.fromRGB(7, 54, 66), -- editor.lineHighlightBackground
    		AcrylicGradient = ColorSequence.new(Color3.fromRGB(74, 9, 1), Color3.fromRGB(74, 9, 1)),
    		AcrylicNoise = 1,
    		TitleBarLine = Color3.fromRGB(199, 4, 4), -- focusBorder
    		Tab = Color3.fromRGB(131, 148, 150), -- editor.foreground
    		Element = Color3.fromRGB(0, 56, 71), -- input.background
    		ElementBorder = Color3.fromRGB(199, 4, 4), -- focusBorder
    		InElementBorder = Color3.fromRGB(199, 4, 4), -- String color
    		ElementTransparency = 0,
    		ToggleSlider = Color3.fromRGB(199, 4, 4), -- String color
    		ToggleToggled = Color3.fromRGB(74, 9, 1), -- editor.background
   		SliderRail = Color3.fromRGB(199, 4, 4), -- String color
    		DropdownFrame = Color3.fromRGB(0, 33, 43), -- dropdown.background
    		DropdownHolder = Color3.fromRGB(0, 33, 43), -- dropdown.background
    		DropdownBorder = Color3.fromRGB(199, 4, 4), -- dropdown.border
    		DropdownOption = Color3.fromRGB(131, 148, 150), -- foreground
    		Keybind = Color3.fromRGB(0, 56, 71), -- input.background
    		Input = Color3.fromRGB(0, 56, 71), -- input.background
    		InputFocused = Color3.fromRGB(0, 56, 71), -- input.background
 		...
 		DialogHolder = Color3.fromRGB(74, 9, 1), -- editor.background
    		DialogHolderLine = Color3.fromRGB(7, 54, 66), -- editor.lineHighlightBackground
    		DialogButton = Color3.fromRGB(0, 56, 71), -- input.background
    		DialogButtonBorder = Color3.fromRGB(199, 4, 4), -- focusBorder
    		DialogBorder = Color3.fromRGB(199, 4, 4), -- focusBorder
    		DialogInput = Color3.fromRGB(0, 56, 71), -- input.background
    		DialogInputLine = Color3.fromRGB(199, 4, 4), -- String color
