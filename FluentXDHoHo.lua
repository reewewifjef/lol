...
local Themes = {
	...
	XDHOHO = {
    	...
    	AcrylicNoise = 1,
    	TitleBarLine = Color3.fromRGB(192, 0, 0), 
    	Tab = Color3.fromRGB(150, 0, 0), 
    	Element = Color3.fromRGB(20, 20, 20), 
    	ElementBorder = Color3.fromRGB(192, 0, 0), 
    	InElementBorder = Color3.fromRGB(192, 0, 0), 
    	ElementTransparency = 0,
    	ToggleSlider = Color3.fromRGB(192, 0, 0), 
    	ToggleToggled = Color3.fromRGB(0, 0, 0), 
   		SliderRail = Color3.fromRGB(192, 0, 0), 
    	DropdownFrame = Color3.fromRGB(10, 10, 10), 
    	DropdownHolder = Color3.fromRGB(10, 10, 10), 
    	DropdownBorder = Color3.fromRGB(192, 0, 0), 
    	...
    	InputIndicator = Color3.fromRGB(150, 0, 0), 
    	Dialog = Color3.fromRGB(10, 10, 10), 
 		DialogHolder = Color3.fromRGB(0, 0, 0), 
    	DialogHolderLine = Color3.fromRGB(20, 20, 20), 
    	DialogButton = Color3.fromRGB(20, 20, 20), 
    	DialogButtonBorder = Color3.fromRGB(192, 0, 0), 
    	DialogBorder = Color3.fromRGB(192, 0, 0), 
    	DialogInput = Color3.fromRGB(20, 20, 20), 
    	DialogInputLine = Color3.fromRGB(192, 0, 0), 
    	Text = Color3.fromRGB(200, 50, 50), 
    	SubText = Color3.fromRGB(150, 0, 0), 
